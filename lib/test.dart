...
class _ActivityPageState extends State<ActivityPage> {
  ...
  List<bool> isExpanded = List.generate(activityList.length, (index) => false);
              ...
              Positioned(
                ...
                child: IconButton(
                  onPressed: () {
                    ...
                    insertToPanier(activityList[index].id);
                  },
                  icon: Icon(
                    panier.any((item) =>
                            item.userId == 1 &&
                            item.dataModelId == activityList[index].id)
                        ? Icons.shopping_cart
      ...
      setState(() {
        panier.add(
          Panier(
            ...
            dataModelId: dataModelId, // ID du Activity sélectionné
          ),
        );
      });
    }
